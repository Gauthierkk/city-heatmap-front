...
const STRINGS: Record<Lang, Record<string, string>> = {
  en: {
    ...
    showHeatmap: 'Show distance heatmap',
    ...
    allSpecies: 'all',
    speciesSelected: '{n} of {total}',
    searchSpecies: 'Search species…',
    noSpeciesMatch: 'No species match.',
  ...
  fr: {
    ...
    showHeatmap: 'Afficher la carte de distance',
    ...
    tree: 'Arbre',
    unknownSpecies: 'Espèce inconnue',
    speciesFilter: 'Espèces',
    allSpecies: 'toutes',
    speciesSelected: '{n} sur {total}',
    searchSpecies: 'Rechercher une espèce…',
    noSpeciesMatch: 'Aucune espèce correspondante.',
